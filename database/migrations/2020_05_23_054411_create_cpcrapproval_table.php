...
class CreateCpcrapprovalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
		 ...
		 * we should have 6 records per a csrform_id */
        Schema::create('cpcrapproval', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('cpcrapproval');
    }
}
