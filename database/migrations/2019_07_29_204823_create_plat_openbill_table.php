...
class CreatePlatOpenbillTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('plat_openbill', function (Blueprint $table) {
           ...
           /*
 			...
 			$table->enum('status',array(
				'vacant','active','printed','voided','completed','paid'))->
					default('vacant');
    ...
    {
        Schema::dropIfExists('plat_openbill');
    }
}
