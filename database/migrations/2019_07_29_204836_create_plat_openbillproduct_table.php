...
class CreatePlatOpenbillproductTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('plat_openbillproduct', function (Blueprint $table) {
			...
			$table->enum('status',array(
				'active','printed','voided','completed','paid'))->
					default('active');
    ...
    {
        Schema::dropIfExists('plat_openbillproduct');
    }
}
