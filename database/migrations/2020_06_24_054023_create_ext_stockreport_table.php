...
class CreateExtStockreportTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ext_stockreport', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ext_stockreport');
    }
}
